...
/**
 * 통계채팅상담(날짜별) Validation체크
 * 
 * @author 이동욱
 */
@Slf4j
@Component
public class StatisticsChatCounselByDateValidator implements Validator
{
    @Override
    ...
    public void validate(Object target, Errors errors)
    {
        ...
        if(objJsonParams.getHeaderString("TYPE").toString().equals("BIZ_SERVICE")) {
            ...
            if(objJsonParams.getHeaderString("METHOD").toString().equals("inqire")) {
                ...
                selectStatisticsByDayValidate(target, errors);
            }
            else {
    ...
    //날짜별상담통계 조회유효성
    public void selectStatisticsByDayValidate(Object target, Errors errors)
    {
