...
@Service("chatReceiveExpiredSessionEventListener")
public class ChatReceiveExpiredSessionEventListener {
     ...
     */
    @EventListener
    public void onExpiredSession(final ChatOnExpiredSessionEvent expiredSessionEvent) throws TelewebAppException {
        ...
        String callTypCd = expiredSessionJson.getString("call_typ_cd");
        String chtCuttId = expiredSessionJson.getString("CHT_CUTT_ID");
        ...
        objParams.setString("CHT_CUTT_ID", chtCuttId);
