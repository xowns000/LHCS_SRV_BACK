...
@Slf4j
@Component
public class StatisticsChatCounselByAgentPopupValidator implements Validator
{
    @Override
    ...
    public void validate(Object target, Errors errors)
    {
        ...
        if(objJsonParams.getHeaderString("TYPE").toString().equals("BIZ_SERVICE")) {
            ...
            if(strTransFlag.equals(TwbCmmnConst.TRANS_UPD)) {
                updateValidate(target, errors);
            }
        }
        if(objJsonParams.getHeaderString("TYPE").toString().equals("BIZ_SERVICE")) {
            if(objJsonParams.getHeaderString("METHOD").toString().equals("popup-user-info-inqire")) {
