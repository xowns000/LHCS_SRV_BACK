...
@Slf4j
@Component
public class ChatQATargetManageValidator implements Validator {
	@Override
	...
	public void validate(Object target, Errors errors) {
		...
		if (objJsonParams.getHeaderString("TYPE").toString().equals("BIZ_SERVICE")) {
			...
			if (objJsonParams.getHeaderString("METHOD").toString().equals("regist")
					|| objJsonParams.getHeaderString("METHOD").toString().equals("modify")
					|| objJsonParams.getHeaderString("METHOD").toString().equals("delete")) {
