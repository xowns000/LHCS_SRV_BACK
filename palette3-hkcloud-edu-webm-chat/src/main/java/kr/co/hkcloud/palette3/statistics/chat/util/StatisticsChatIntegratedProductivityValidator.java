...
@Slf4j
@Component
public class StatisticsChatIntegratedProductivityValidator implements Validator
{
    @Override
    ...
    public void validate(Object target, Errors errors)
    {
        ...
        if(objJsonParams.getHeaderString("TYPE").toString().equals("BIZ_SERVICE")) {
            ...
            if(objJsonParams.getHeaderString("METHOD").toString().equals("inqire")) {
                ...
                selectIntergratedProductivityValidate(target, errors);
            }
            else {
    ...
    //통합생산성통계 조회유효성
    public void selectIntergratedProductivityValidate(Object target, Errors errors)
    {
        ...
        if(StringUtils.length(objJsonParams.getString("INQRY_TYP_CD_2LEVEL")) < 0 || StringUtils.length(objJsonParams.getString("INQRY_TYP_CD_2LEVEL")) > 6) {
            Object[] arg = new Object[1];
