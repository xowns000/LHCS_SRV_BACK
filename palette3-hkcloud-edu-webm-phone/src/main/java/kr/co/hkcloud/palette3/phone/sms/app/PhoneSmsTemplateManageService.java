...
public interface PhoneSmsTemplateManageService
{
    /**
     * SMS트리 조회
     *
...
//    TelewebJSON isRegTmplClsf(TelewebJSON jsonParams) throws TelewebAppException;
     ...
     * @throws TelewebAppException 
     */
    TelewebJSON modifyTmplClsf(TelewebJSON jsonParams) throws TelewebAppException;
     ...
     * @throws TelewebAppException
     */
    TelewebJSON selectSmsList(TelewebJSON jsonParams) throws TelewebAppException;
	...
	/**
	 * 템플릿 분류 트리 노드 위로 순서 변경
	 * @param mjsonParams
	 * @return
	 * @throws TelewebAppException
	 */
	TelewebJSON changeTmplClsfSortOrder(TelewebJSON mjsonParams) throws TelewebAppException;
