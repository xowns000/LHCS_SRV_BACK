package kr.co.hkcloud.palette3.phone.main.util;
...
/**
 * 전화메인 Validation체크 PhoneMainValidator 사용하는데 확인 필요
 * 
 * @author R&D
 */
@Slf4j
@Component
public class PhoneMainValidator implements Validator
{
    @Override
    ...
    public void validate(Object target, Errors errors)
    {
        ...
        if(objJsonParams.getHeaderString("METHOD").toString().equals("SCRIPTS")) {
