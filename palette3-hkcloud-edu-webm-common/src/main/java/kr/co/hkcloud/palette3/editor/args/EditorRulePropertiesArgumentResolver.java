package kr.co.hkcloud.palette3.editor.args;
...
@Component
public class EditorRulePropertiesArgumentResolver implements HandlerMethodArgumentResolver
{
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory)
    {
        ...
        EditorPropertiesResponse editorPropertiesResponse = editorRulePropertiesUtils.getProperties(taskTypeCd, pathTypeCd);
        log.trace("editorPropertiesResponse={}", editorPropertiesResponse);
    ...
    public boolean supportsParameter(MethodParameter parameter)
    {
        ...
        return parameter.hasParameterAnnotation(EditorRuleProperties.class);
