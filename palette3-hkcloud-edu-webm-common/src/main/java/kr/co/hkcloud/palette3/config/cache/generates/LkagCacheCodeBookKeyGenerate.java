 ...
 */
@Slf4j
public class LkagCacheCodeBookKeyGenerate
{
    /**
     * 키 생성
     * 
    ...
    {
        String groupCd = jsonParams.getString("LKAG_GROUP_CD_ID");
        StringBuffer sbKey = new StringBuffer(groupCd.trim());
        log.debug("**palette:cache:lkag-code-book Key Generate =[{}]", sbKey.toString());
