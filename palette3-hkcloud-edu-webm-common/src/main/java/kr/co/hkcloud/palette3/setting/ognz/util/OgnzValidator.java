package kr.co.hkcloud.palette3.setting.ognz.util;
...
/**
 * 
 * Description : 조직 관리 Validation체크
 * package  : kr.co.hkcloud.palette3.setting.ognz.util
 * filename : OgnzValidator.java
 * Date : 2023. 6. 7.
 * History :
...
@Slf4j
@Component
public class OgnzValidator implements Validator
{
    @Override
