...
import kr.co.hkcloud.palette3.servlet.dhtmlx.app.HTMLWriter;
import lombok.extern.slf4j.Slf4j;


@Slf4j
@WebServlet(urlPatterns = {"/servlet/HTMLGenerator"})
public class HTMLGenerator extends HttpServlet
{
    /**
     * 
     */
    private static final long serialVersionUID = 6992558624075064655L;
