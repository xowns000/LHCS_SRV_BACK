...
public final class KakaoBase64Encoder
{
    private static final char   BASE64_PADDING = '=';
    private static final String BASE64_CHARS   = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";


    private KakaoBase64Encoder() {
    }
     ...
     * 
     * @param  value A byte array to encode. If it is null or a zero-length array, an empty string is returned.
     ...
     * 
     * @param  value     A Base64 encoded string to decode. The length of the string must be a multiple of 4. If it is null or an empty string, a zero-length array is returned.
