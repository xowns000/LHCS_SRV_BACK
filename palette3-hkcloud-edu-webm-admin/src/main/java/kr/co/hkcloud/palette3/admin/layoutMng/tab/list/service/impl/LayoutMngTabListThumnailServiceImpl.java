...
import kr.co.hkcloud.palette3.admin.layoutMng.tab.list.service.LayoutMngTabListThumnailService;
...
public class LayoutMngTabListThumnailServiceImpl implements LayoutMngTabListThumnailService {
    ...
    public TelewebJSON selectThumnail(TelewebJSON jsonParam) throws TelewebAppException {
        ...
        objRetParam = twbComDao.select("kr.co.hkcloud.palette3.admin.layoutMng.tab.list.dao.LayoutMngTabListThumnailMapper",
            "selectThumnail", jsonParam);
        return objRetParam;
    }
    ...
    public TelewebJSON insertUpdateThumnail(TelewebJSON jsonParam) throws TelewebAppException {
        ...
        if (StringUtils.isEmpty(jsonParam.getString("RSPNS_ARTCL_ID"))) {
            ...
            if (StringUtils.isEmpty(jsonParam.getString("LIST_ID"))) {
                ...
                objRetParam = twbComDao.insert("kr.co.hkcloud.palette3.admin.layoutMng.tab.list.dao.LayoutMngTabListThumnailMapper",
                    "insertThumnail", jsonParam);                             // LIST_ID로 PLT_LAYOUT_LIST_THUMNAIL INSERT
                objRetParam.setInt("__KEY_ID", jsonParam.getInt("LIST_ID"));
            } else {
                objRetParam = twbComDao.update("kr.co.hkcloud.palette3.admin.layoutMng.tab.list.dao.LayoutMngTabListThumnailMapper",
                    "updateThumnail", jsonParam);
                objRetParam.setInt("__KEY_ID", jsonParam.getInt("LIST_ID"));
            }
        }
        return objRetParam;
    ...
    public TelewebJSON deleteThumnail(TelewebJSON jsonParam) throws TelewebAppException {
        ...
        if (!StringUtils.isEmpty(jsonParam.getString("LIST_ID")) && !StringUtils.isEmpty(jsonParam.getString("TAB_ID"))) {
            twbComDao.delete("kr.co.hkcloud.palette3.admin.layoutMng.tab.list.dao.LayoutMngTabListThumnailMapper", "deleteThumnail",
                jsonParam);
            layoutMngTabListService.deleteList(jsonParam);
//            twbComDao.delete("kr.co.hkcloud.palette3.admin.layoutMng.tab.list.dao.LayoutMngTabListMapper", "deleteList", jsonParam);
        }
        return objRetParam;
    }
}
