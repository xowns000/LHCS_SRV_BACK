...
(
	SRVY_CLSF_ID          BIGINT  NOT NULL ,
	UP_SRVY_CLSF_ID       BIGINT  NULL ,
	SRVY_CLSF_NM          VARCHAR(200)  NULL ,
	SRVY_CLSF_EXPLN       VARCHAR(2000)  NULL ,
	SORT_ORD              INT  NULL ,
	USE_YN                CHAR(1)  NULL ,
	DEL_YN                CHAR(1)  NULL ,
...
(
	SRVY_EXL_TRGT_ID      BIGINT  NOT NULL ,
	EXL_SE_CD             VARCHAR(60)  NULL ,
	CUST_NM               VARCHAR(300)  NULL ,
	CUST_PHN_NO           VARCHAR(60)  NULL ,
	EXL_BGNG_DT           VARCHAR(14)  NULL ,
	EXL_END_DT            VARCHAR(14)  NULL ,
	EXL_RSN               VARCHAR(1000)  NULL ,
	DEL_YN                CHAR(1)  NULL ,
	REG_DT                VARCHAR(14)  NOT NULL ,
	RGTR_ID               BIGINT  NOT NULL ,
	MDFCN_DT              VARCHAR(14)  NULL ,
...
(
	SRVY_STTS_HSTRY_ID    BIGINT  NOT NULL ,
	SRVY_ID               BIGINT  NULL ,
...
ALTER TABLE PLT_SRVY_QITEM_GROUP ADD MVMN_SRVY_QITEM_GROUP_ID  BIGINT  NULL;
...
ALTER TABLE PLT_SRVY_QITEM ADD SRVY_CLSF_ID BIGINT  NULL;
...
ALTER TABLE PLT_SRVY_QITEM ALTER COLUMN SRVY_QITEM_GROUP_ID DROP NOT NULL;
...
ALTER TABLE PLT_SRVY_QITEM_CHC ADD MVMN_SRVY_QITEM_GROUP_ID BIGINT  NULL;
...
ALTER TABLE PLT_SRVY_RSPNS_QITEM_CHC ADD RSPNS_CN VARCHAR(4000)  NULL;
COMMENT ON COLUMN PLT_SRVY_RSPNS_QITEM_CHC.RSPNS_CN IS '응답_내용';


ALTER TABLE PLT_EXPSN_ATTR ADD SRVY_ID BIGINT  NULL;
...
select 'CATG_EXT_CL', 'SRVY', custco_id, '설문참여자', 'Survey Target', NULL, 'Y', 'Y', 'N', 4, '2', to_char(now(), 'yyyymmddhh24miss'), NULL, NULL from plt_custco ON CONFLICT (group_cd_id, cd_id, custco_id) DO nothing;


--설문 진행상태 추가
INSERT INTO plt_comm_cd
(group_cd_id, cd_id, custco_id, cd_nm, cd_expln, cd_vl, sys_cd_yn, use_yn, del_yn, sort_ord, rgtr_id, reg_dt, mdfr_id, mdfcn_dt)
select 'PROG_ST', 'RDY', custco_id, '승인대기', '승인대기', NULL, 'Y', 'Y', 'N', 2, '2', to_char(now(), 'yyyymmddhh24miss'), NULL, NULL from plt_custco ON CONFLICT (group_cd_id, cd_id, custco_id) DO nothing;

INSERT INTO plt_comm_cd
(group_cd_id, cd_id, custco_id, cd_nm, cd_expln, cd_vl, sys_cd_yn, use_yn, del_yn, sort_ord, rgtr_id, reg_dt, mdfr_id, mdfcn_dt)
select 'PROG_ST', 'RFSL', custco_id, '승인반려', '승인반려', NULL, 'Y', 'Y', 'N', 3, '2', to_char(now(), 'yyyymmddhh24miss'), NULL, NULL from plt_custco ON CONFLICT (group_cd_id, cd_id, custco_id) DO nothing;

INSERT INTO plt_comm_cd
(group_cd_id, cd_id, custco_id, cd_nm, cd_expln, cd_vl, sys_cd_yn, use_yn, del_yn, sort_ord, rgtr_id, reg_dt, mdfr_id, mdfcn_dt)
select 'PROG_ST', 'RTRVL', custco_id, '승인회수', '승인회수', NULL, 'Y', 'Y', 'N', 4, '2', to_char(now(), 'yyyymmddhh24miss'), NULL, NULL from plt_custco ON CONFLICT (group_cd_id, cd_id, custco_id) DO nothing;

INSERT INTO plt_comm_cd
(group_cd_id, cd_id, custco_id, cd_nm, cd_expln, cd_vl, sys_cd_yn, use_yn, del_yn, sort_ord, rgtr_id, reg_dt, mdfr_id, mdfcn_dt)
select 'PROG_ST', 'APPR', custco_id, '승인완료', '승인완료', NULL, 'Y', 'Y', 'N', 5, '2', to_char(now(), 'yyyymmddhh24miss'), NULL, NULL from plt_custco ON CONFLICT (group_cd_id, cd_id, custco_id) DO nothing;
...
INSERT INTO plt_comm_cd
(group_cd_id, cd_id, custco_id, cd_nm, cd_expln, cd_vl, sys_cd_yn, use_yn, del_yn, sort_ord, rgtr_id, reg_dt, mdfr_id, mdfcn_dt)
select '*', 'SUVY_EXL_TRGT_TP', CUSTCO_ID, '설문 참여자 제외 유형', '설문 참여자 제외 유형', NULL, 'Y', 'Y', 'N', (select MAX(SORT_ORD)+1 from plt_comm_cd where GROUP_CD_ID='*'), '2', to_char(now(), 'yyyymmddhh24miss'), NULL, NULL from plt_custco ON CONFLICT (group_cd_id, cd_id, custco_id) DO nothing;;

INSERT INTO plt_comm_cd
(group_cd_id, cd_id, custco_id, cd_nm, cd_expln, cd_vl, sys_cd_yn, use_yn, del_yn, sort_ord, rgtr_id, reg_dt, mdfr_id, mdfcn_dt)
select 'SUVY_EXL_TRGT_TP', 'DENY', custco_id, '설문거부', '설문거부', NULL, 'Y', 'Y', 'N', 1, '2', to_char(now(), 'yyyymmddhh24miss'), NULL, NULL from plt_custco ON CONFLICT (group_cd_id, cd_id, custco_id) DO nothing;

INSERT INTO plt_comm_cd
(group_cd_id, cd_id, custco_id, cd_nm, cd_expln, cd_vl, sys_cd_yn, use_yn, del_yn, sort_ord, rgtr_id, reg_dt, mdfr_id, mdfcn_dt)
select 'SUVY_EXL_TRGT_TP', 'EXCLUDE', custco_id, '설문제외', '설문제외', NULL, 'Y', 'Y', 'N', 2, '2', to_char(now(), 'yyyymmddhh24miss'), NULL, NULL from plt_custco ON CONFLICT (group_cd_id, cd_id, custco_id) DO nothing;


--설문 참여자 제외 검색 유형 추가
INSERT INTO plt_comm_cd
(group_cd_id, cd_id, custco_id, cd_nm, cd_expln, cd_vl, sys_cd_yn, use_yn, del_yn, sort_ord, rgtr_id, reg_dt, mdfr_id, mdfcn_dt)
select '*', 'SUVY_EXL_SRCH_TP', CUSTCO_ID, '설문 참여자 제외 검색 유형', '설문 참여자 제외 검색 유형', NULL, 'Y', 'Y', 'N', (select MAX(SORT_ORD)+1 from plt_comm_cd where GROUP_CD_ID='*'), '2', to_char(now(), 'yyyymmddhh24miss'), NULL, NULL from plt_custco ON CONFLICT (group_cd_id, cd_id, custco_id) DO nothing;;

INSERT INTO plt_comm_cd
(group_cd_id, cd_id, custco_id, cd_nm, cd_expln, cd_vl, sys_cd_yn, use_yn, del_yn, sort_ord, rgtr_id, reg_dt, mdfr_id, mdfcn_dt)
select 'SUVY_EXL_SRCH_TP', 'CUST_NM', custco_id, '성명', '성명', NULL, 'Y', 'Y', 'N', 1, '2', to_char(now(), 'yyyymmddhh24miss'), NULL, NULL from plt_custco ON CONFLICT (group_cd_id, cd_id, custco_id) DO nothing;

INSERT INTO plt_comm_cd
(group_cd_id, cd_id, custco_id, cd_nm, cd_expln, cd_vl, sys_cd_yn, use_yn, del_yn, sort_ord, rgtr_id, reg_dt, mdfr_id, mdfcn_dt)
select 'SUVY_EXL_SRCH_TP', 'CUST_PHN_NO', custco_id, '전화번호', '전화번호', NULL, 'Y', 'Y', 'N', 2, '2', to_char(now(), 'yyyymmddhh24miss'), NULL, NULL from plt_custco ON CONFLICT (group_cd_id, cd_id, custco_id) DO nothing;




--이메일 발송 관리 - 설문_대상_ID 추가.
ALTER TABLE PLT_EML_SNDNG_HSTRY ADD IF NOT EXISTS SRVY_TRGT_ID BIGINT NULL;
COMMENT ON COLUMN PLT_EML_SNDNG_HSTRY.SRVY_TRGT_ID IS '설문_대상_ID';

CREATE INDEX IF NOT EXISTS PLT_EML_SNDNG_HSTRY_F4 ON PLT_EML_SNDNG_HSTRY
(SRVY_TRGT_ID  ASC);

ALTER TABLE PLT_EML_SNDNG_HSTRY DROP CONSTRAINT IF EXISTS R_EML_SNDNG_HSTRY_2__SRVY_TRGT;
...
(
   EML_TMPL_ID           BIGINT  NOT NULL ,
   TMPL_CLSF_ID          BIGINT  NULL ,
   TMPL_TYPE_CD          VARCHAR(60)  NULL ,
   TMPL_NM               VARCHAR(200)  NULL ,
   TMPL_CN               VARCHAR(4000)  NULL ,
...
--참여자 개인정보 암호화
ALTER TABLE plt_srvy_trgt ADD cust_nm_orgnl varchar(300) NULL;
COMMENT ON COLUMN plt_srvy_trgt.cust_nm_orgnl IS '고객_명_원본';
ALTER TABLE plt_srvy_trgt ADD cust_phn_no_orgnl varchar(60) NULL;
COMMENT ON COLUMN plt_srvy_trgt.cust_phn_no_orgnl IS '고객_전화_번호_원본';
ALTER TABLE plt_srvy_trgt ADD eml_orgnl varchar(60) NULL;
COMMENT ON COLUMN plt_srvy_trgt.eml_orgnl IS '이메일_원본';


ALTER TABLE plt_srvy_trgt ALTER COLUMN cust_phn_no TYPE varchar(300) USING cust_phn_no::varchar(300);
ALTER TABLE plt_srvy_trgt ALTER COLUMN eml TYPE varchar(300) USING eml::varchar(300);
...
update plt_srvy_trgt set
cust_nm = custco.gen_encrypt(cust_nm, 'PL30', 'aes'),
cust_phn_no = custco.gen_encrypt(cust_phn_no, 'PL30', 'aes'),
eml = custco.gen_encrypt(eml, 'PL30', 'aes');
...
VALUES((SELECT MAX(MENU_ID) FROM PLT_MENU) + 1, 33, NULL, '2', '설문조사 승인 관리', '설문조사 진행을 위해 설문 시행계획을 승인하고 관리할 수 있습니다.', NULL, NULL, 'MAIN', '/SVY_M0500', '0', '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '5', 'Y', 'N', '2', to_char(now(),'yyyymmddhh24miss'), NULL, NULL);
...
select authrt_group_id, (SELECT MAX(MENU_ID) FROM PLT_MENU), NULL, NULL, NULL, NULL, NULL, NULL, '2', to_char(now(),'yyyymmddhh24miss'), NULL, null from plt_authrt where user_se_cd ='MANAGER';


INSERT INTO PLT_MENU(MENU_ID,UP_MENU_ID,LNKG_MENU_ID,MENU_SE_CD_LVL,MENU_NM,MENU_EXPLN,POPUP_FILE_NM,PRGRM_PARAM,VIEW_TRGT,PATH_NM,POPUP_WD_SZ,POPUP_HT_SZ,ICON_CLASS_NM,ACT_NM,INQ_AUTHRT,PRCS_AUTHRT,DEL_AUTHRT,OTPT_AUTHRT,EXCL_AUTHRT,ADD_AUTHRT,SORT_ORD,USE_YN,DEL_YN,RGTR_ID,REG_DT,MDFR_ID,MDFCN_DT) 
VALUES((SELECT MAX(MENU_ID) FROM PLT_MENU) + 1, 33, NULL, '2', '설문문항 관리', '설문지에 사용할 설문문항을 관리합니다.', NULL, NULL, 'MAIN', '/SVY_M0400', '0', '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2', 'Y', 'N', '2', to_char(now(),'yyyymmddhh24miss'), NULL, NULL);
...
select (select max(ATTR_ID)+1 from PLT_EXPSN_ATTR), custco_id, 'N', 'ENV', NULL, '설문 대상지정 사용 여부', '설문 대상지정 사용 여부', 'ENV_SRVY_TRGT_DSGN_USE_YN', 'COE', '60', 'USE_WT', 'Y', 'Y', 'N', 'Y', 'N', (select max(sort_ord)+1 from PLT_EXPSN_ATTR where se='ENV'), NULL, NULL, 2, to_char(now(), 'yyyymmddhh24miss'), NULL, NULL, NULL, NULL, 'N', 'Y' from plt_custco;
