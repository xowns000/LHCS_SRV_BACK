...
VALUES((SELECT MAX(MENU_ID) FROM PLT_MENU) + 1, 77, NULL, '3', '시스템 로그 조회', '시스템 로그를 조회합니다.', NULL, NULL, 'MAIN', '/STG_M0611', '0', '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '11', 'Y', 'N', '2', to_char(now(),'yyyymmddhh24miss'), NULL, NULL);
