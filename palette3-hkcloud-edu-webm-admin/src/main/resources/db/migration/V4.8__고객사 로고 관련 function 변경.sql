...
BEGIN
	...
	loopCnt := 1;
	dynamic_query := 'SELECT SCHEMA_ID, CD, CD_NM, ASP_CUST_KEY, API_URI, USER_ID, EXT_NO, PDS_EXT_NO, DSPTCH_NO, CUSTCO_ICON FROM (';
	...
	LOOP
		...
		dynamic_query := dynamic_query || 'SELECT '
			 ...
			 LEFT OUTER JOIN custco.PLT_CERT_CUSTCO PCC ON PCC.ASP_CUST_KEY = PC.ASP_CUST_KEY
