package kr.co.hkcloud.palette3.integration.commerce_api.goodwearmall.service;
 ...
 */
@Slf4j
@Service(GoodWearMallServiceImpl.BEAN_ID)
public class GoodWearMallServiceImpl extends CommerceLkagServiceImpl implements CommerceApiService {
    public static final String BEAN_ID = "GOODWEARMALL";

    public GoodWearMallServiceImpl(TwbComDAO mobjDao, PaletteJsonUtils paletteJsonUtils, PaletteLkagRestTemplate paletteLkagRestTemplate,
