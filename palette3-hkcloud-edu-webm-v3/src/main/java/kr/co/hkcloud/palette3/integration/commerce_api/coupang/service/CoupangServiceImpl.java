package kr.co.hkcloud.palette3.integration.commerce_api.coupang.service;
 ...
 */
@Slf4j
@Service(CoupangServiceImpl.BEAN_ID)
public class CoupangServiceImpl extends CommerceLkagServiceImpl implements CommerceApiService {
    public static final String BEAN_ID = "COUPANG";

    public CoupangServiceImpl(TwbComDAO mobjDao, PaletteJsonUtils paletteJsonUtils, PaletteLkagRestTemplate paletteLkagRestTemplate,
